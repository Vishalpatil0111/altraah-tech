      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed max-w-md">
              Leading manufacturer of high-performance LED PCBs with 13+ years of expertise. 
              ISO 9001:2015 certified quality and innovation.
            </p>
            <div className="flex space-x-4">
              <a href="https://instagram.com" className="w-10 h-10 bg-yellow-500 rounded-lg flex items-center justify-center hover:bg-yellow-400 transition-colors">
              ...
              <a href="https://facebook.com" className="w-10 h-10 bg-yellow-500 rounded-lg flex items-center justify-center hover:bg-yellow-400 transition-colors">
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="https://linkedin.com" className="w-10 h-10 bg-yellow-500 rounded-lg flex items-center justify-center hover:bg-yellow-400 transition-colors">
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/products" className="text-gray-300 hover:text-yellow-400 transition-colors">Products</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm">Plot No D-15, Behind Amber Auto, Datir Mala, Navnath Nagar, Ambad MIDC Road, Nashik 422010</span>
              </li>
              <li className="flex items-center gap-3">
                ...
                <span className="text-sm">+91 866 868 3583</span>
              </li>
              <li className="flex items-center gap-3">
                <svg className="w-5 h-5 text-yellow-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-sm">altrahtechcirart@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 Altraah LED PCB. All rights reserved.
          </p>
